    ...
    public class CrawlerThread
    {
        ...
        private static void Fetch(CrawlerThread crawler, string url)
        {
            try
            {
                ...
                //string[] links = Parser.ExtractLinks(baseUri, html, @"/scenery_\d+\.html");
                string[] links = Parser.ExtractLinks(baseUri, html, @"/lishui/.+\.html");
                ...
                if (contentType.Contains("text/html"))
                {
                    ...
                    foreach (string link in links)
                    {
                        ...
                        //     link.EndsWith(".gif"))
                        //{
                        //    queue.Enqueue(link, FrontierQueuePriority.AboveNormal);
                        //}
                        //else
                        //{
                        //    queue.Enqueue(link);
