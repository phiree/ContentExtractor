...
namespace CE.Crawler
{
    ...
    public class Parser
    {
        ...
        public static string[] ExtractLinks(string baseUri, string html) {
            return ExtractLinks(baseUri, html, string.Empty);
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <param name="includeExp">只需要符合条件的正则表达式</param>
        /// <returns></returns>
        public static string[] ExtractLinks(string baseUri, string html,string includeExp)
        {
            ...
            try
            {
                ...
                foreach (Match match in matches)
                {
                    ...
                    { continue; }
                    if (!Regex.IsMatch(rawHref, includeExp))
                    { continue; }
