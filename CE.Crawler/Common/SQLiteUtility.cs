...
namespace CE.Crawler.Common
{
    ...
    public class SQLiteUtility
    {
        ...
        //    "[pr_rank] FLOAT default 0 not null," +
        //    "[vc_url] VARCHAR(255)  UNIQUE NOT NULL," +
        //    "[i_status] INTEGER DEFAULT 0 NOT NULL," +
        //    "[i_mime] INTEGER DEFAULT 0 NOT NULL," +
        //    "[blob_resource] BLOB  NULL," +
        //    "[dt_start_time] DATE  NULL," +
        //    "[dt_end_time] DATE  NULL," +
        //    "[i_retry_count] INTEGER DEFAULT 0 NULL," +
        //    "[dt_created_time] TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL," +
        //    "[vc_agent_name] VARCHAR(64)  NULL," +
        //    "[vc_server_name] VARCHAR(64)  NULL," +
        //    "[i_size] INTEGER DEFAULT 0 NOT NULL," +
        //    "[outer_links] INTEGER DEFAULT 0 NOT NULL)";
